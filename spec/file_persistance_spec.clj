...
(describe "this file will control the saving and extracting of game states"
  ...
  (it "retrieves last played game"
    (spit "game-state.txt" "{:board {:state [:e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e :e], :size 3, :dimension :three}, :player :x, :game-number 1, :difficulty 3, :difficulty2 3}")
  ...
  (it "grabs every game that has been played"
    (should= ""  (with-out-str (grab-games "games-state.txt"))))
